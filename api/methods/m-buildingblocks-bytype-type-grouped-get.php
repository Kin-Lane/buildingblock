...
$app->get($route, function ($type)  use ($app){
	...
	while ($Category = mysql_fetch_assoc($CategoryResult))
		...
		$Query = "SELECT b.Building_Block_ID,b.Building_Block_Category_ID,b.Name,b.About,b.Sort_Order,bbc.Name,bbc.Image,bbc.Hex AS Category,bbc.Type as Type FROM building_block b";
